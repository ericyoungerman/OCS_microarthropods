...
pred_water_capacity.gauss<- glmmTMB(pred_water_capacity~ system* entry + block + (1 | block:system),
                      data = ocs_soil_health_clean,
                      family = gaussian())

pred_water_capacity.gamma <- glmmTMB(pred_water_capacity~ system * entry + block + (1 | block:system),
                                     data = ocs_soil_health_clean,
...
simulateResiduals(pred_water_capacity.gamma,plot = TRUE) 

check_model(pred_water_capacity.gamma)
...
pred_water_capacity.anova <- test_terms(formula = pred_water_capacity~ system * entry + block, # fixed effects go here
                                   ...
                                   extra_formula = ~ (1|block:system), # random effects go here
                                   fit_fun = glmmTMB,
                                   fit_arg = list(family = Gamma(link = "log")));pred_water_capacity.anova 
...
subsurface_hardness.gamma <- glmmTMB(subsurface_hardness~ system * entry + block + (1 | block:system),
                                     data = ocs_soil_health_clean,
                                     family = Gamma(link = "log"))
...
subsurface_hardness.anova <- test_terms(formula = subsurface_hardness~ system * entry + block, # fixed effects go here
                                   ...
                                   extra_formula = ~ (1|block:system), # random effects go here
                                   fit_fun = glmmTMB,
                                   fit_arg = list(family = Gamma(link = "log")));subsurface_hardness.anova 
